...
<template>
  <tr
    class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors duration-200 cursor-pointer"
  ...
  >
    ...
    <td class="px-6 py-4 whitespace-nowrap">
      <div
        class="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-medium border"
    ...
    <td class="px-6 py-4 whitespace-nowrap">
      <div class="w-8 h-8 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center hover:bg-primary-100 dark:hover:bg-primary-900/30 transition-colors duration-200">
        <svg class="w-4 h-4 text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
