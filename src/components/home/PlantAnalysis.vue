...
import type { LogSystem, Settings } from '@/composables/responseApi'
...
const recommendations = computed(() => {
  if (props.settings.thresholds.airHumidity.max == 0 || props.sensorData.airHumidity.value == 0)
    return []

  const result = []

  if (props.sensorData.soilMoisture.value < props.settings.thresholds.soilMoisture.min) {
    result.push({
      id: 1,
      type: 'error',
  ...
  } else if (props.sensorData.soilMoisture.value > props.settings.thresholds.soilMoisture.max) {
    result.push({
      id: 1,
      type: 'warning',
      title: 'Excess Moisture',
      description: 'Soil is too wet. Ensure proper drainage to avoid root rot.',
      priority: 'medium',
      icon: 'M5 13l4 4L19 7',
  ...
  if (
    props.sensorData.soilPH.value < props.settings.thresholds.soilPH.min ||
    props.sensorData.soilPH.value > props.settings.thresholds.soilPH.max
  ) {
    result.push({
      id: 2,
      type: 'error',
  ...
  if (props.sensorData.airTemperature.value < props.settings.thresholds.airTemperature.min) {
    result.push({
      id: 3,
      type: 'error',
      title: 'Low Temperature Warning',
      description: 'Air temperature is very low. Protect plants from cold stress.',
      priority: 'high',
  ...
  } else if (props.sensorData.airTemperature.value > props.settings.thresholds.airTemperature.max) {
    result.push({
      id: 3,
      type: 'error',
  ...
  if (props.sensorData.airHumidity.value < props.settings.thresholds.airHumidity.min) {
    result.push({
      id: 4,
      type: 'error',
  ...
  } else if (props.sensorData.airHumidity.value > props.settings.thresholds.airHumidity.max) {
    result.push({
      id: 4,
      type: 'warning',
  ...
  >
    ...
    <div class="p-3 xs:p-4 sm:p-6">
      ...
      <div class="flex items-start xs:items-center gap-2.5 xs:gap-3 sm:gap-4 mb-4 xs:mb-6 sm:mb-8">
        ...
        >
          <svg
            class="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6 text-emerald-600 dark:text-emerald-400"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        <div class="min-w-0 flex-1">
          <h2
            class="text-base xs:text-lg sm:text-xl font-semibold text-gray-900 dark:text-gray-100 truncate"
          >
            Plant Growth Analysis
          </h2>
          <p
            class="text-xs xs:text-sm text-gray-600 dark:text-gray-400 mt-0.5 line-clamp-2 xs:line-clamp-none"
          >
      ...
      <div class="grid md:grid-cols-2 gap-4 xs:gap-5 sm:gap-6 mb-4 xs:mb-6 sm:mb-8">
        <!-- Health Score Card -->
        <div
          class="rounded-lg xs:rounded-xl p-3 xs:p-4 sm:p-5 bg-gradient-to-br ring-1"
        ...
        >
          <div class="flex items-center justify-between mb-3 xs:mb-4">
            <div class="flex items-center gap-2 xs:gap-3">
              ...
              <div>
                <div
                  class="text-2xs xs:text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide"
                >
                  Plant Health Score
                </div>
          ...
          <div class="w-full bg-gray-200/60 dark:bg-gray-700/60 rounded-full h-1.5 xs:h-2">
            <div
              class="h-1.5 xs:h-2 rounded-full transition-all duration-700 ease-out"
              :class="healthScoreBar"
        ...
        >
          <div class="flex items-center gap-2 mb-2 xs:mb-3">
            ...
            >
              <svg
                class="w-4 h-4 xs:w-4.5 xs:h-4.5 text-blue-600 dark:text-blue-400"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
      ...
      <div class="grid lg:grid-cols-2 gap-4 xs:gap-5 sm:gap-6 lg:gap-8 items-stretch">
        ...
        <div class="space-y-4 xs:space-y-5 sm:space-y-6">
          ...
          <div class="flex items-center gap-2 xs:gap-2.5 sm:gap-3">
            ...
            >
              <svg
                class="w-3.5 h-3.5 xs:w-4 xs:h-4 sm:w-5 sm:h-5 text-blue-600 dark:text-blue-400"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <h3
              class="text-sm xs:text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100"
            >
          ...
          <div class="space-y-3 xs:space-y-3.5 sm:space-y-4">
            ...
            <div
              ...
              class="flex flex-col items-center justify-center text-center rounded-lg xs:rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50/70 dark:bg-gray-800/30 p-6 sm:p-8 shadow-sm"
            >
              <div
                class="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-full bg-gradient-to-br from-green-100/80 to-green-50/60 dark:from-green-900/30 dark:to-green-800/20 ring-1 ring-green-200/50 dark:ring-green-700/30 mb-3"
              >
                <svg
              ...
              <h4 class="text-sm sm:text-base font-semibold text-gray-900 dark:text-gray-100 mb-1">
                All Conditions Optimal
              </h4>
              <p
                class="text-xs sm:text-sm text-gray-600 dark:text-gray-400 leading-relaxed max-w-xs"
              >
                Your plants are in great condition. No immediate actions are needed.
              </p>
            </div>
            ...
            >
              <!-- Accent bar -->
              <div
                class="absolute top-0 left-0 w-1 h-full rounded-l-lg xs:rounded-l-xl"
                :class="rec.iconColor"
              ></div>
              ...
              >
                <svg
                  class="w-4 h-4 xs:w-4.5 xs:h-4.5 sm:w-5 sm:h-5"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  :class="rec.iconColor"
              ...
              <div class="flex-1 min-w-0">
                <div class="flex flex-wrap items-center gap-1.5 xs:gap-2 mb-1">
                  ...
                  <span
                    class="px-1.5 xs:px-2 py-0.5 text-2xs xs:text-xs rounded-full font-medium capitalize"
                    :class="{
        ...
        <div class="space-y-4 xs:space-y-5 sm:space-y-6">
          ...
          >
            ...
            <div v-else>
              ...
              >
                ...
                <div class="flex flex-col gap-1 sm:hidden">
                  <div class="flex items-center justify-between gap-2">
                    ...
                    <span
                      class="font-semibold capitalize text-2xs"
                      :class="{
                ...
                <div class="hidden sm:flex items-start gap-3">
                  ...
                  <span
                    class="font-semibold capitalize w-20"
                    :class="{
                      'text-red-500': log.level === 'critical',
                      'text-yellow-500': log.level === 'warning',
                      'text-green-500': log.level === 'ok',
              ...
              <!-- Toggle Button -->
              <div
                v-if="props.logs && props.logs.length > 10"
