    ...
    <div class="p-6">
      ...
      <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
        ...
        <div class="flex items-start gap-4">
          <div class="flex-shrink-0 relative">
            <div class="w-14 h-14 bg-gradient-to-br from-emerald-100 to-emerald-50 dark:from-emerald-900/30 dark:to-emerald-800/20 rounded-2xl flex items-center justify-center ring-1 ring-emerald-200/50 dark:ring-emerald-700/30">
          ...
          <div>
            <h1 class="text-2xl lg:text-3xl font-semibold text-gray-900 dark:text-gray-100 tracking-tight">
        ...
        <div class="flex items-center gap-3">
          ...
          <button
            @click="exportData"
            class="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 rounded-xl transition-all duration-200 shadow-sm hover:shadow-md transform hover:scale-[1.02] active:scale-[0.98]"
          >
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-6 mt-6 border-t border-gray-200 dark:border-gray-700">
        ...
        <div class="flex items-center gap-6 text-sm">
          <div class="flex items-center gap-2">
            <div class="relative">
              ...
              <div class="absolute inset-0 w-2.5 h-2.5 bg-emerald-500 rounded-full animate-ping opacity-75"></div>
            </div>
        ...
        <div class="flex items-center gap-6">
          ...
          <div class="flex items-center gap-3">
            <div class="w-10 h-10 bg-gradient-to-br from-emerald-100 to-emerald-50 dark:from-emerald-900/30 dark:to-emerald-800/20 rounded-xl flex items-center justify-center ring-1 ring-emerald-200/50 dark:ring-emerald-700/30">
