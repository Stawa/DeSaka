...
<template>
  ...
  >
    <div class="h-full flex flex-col">
      <!-- Header -->
      <div class="flex items-center h-16 lg:h-18 px-6 border-b border-gray-200/30 dark:border-gray-800/30">
        <div class="flex items-center" :class="isCollapsed ? 'lg:justify-center lg:w-full' : ''">
          <div class="relative">
            ...
            <div class="absolute -inset-1 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl blur opacity-20 animate-float"></div>
          </div>
        ...
        <button
          @click="$emit('close')"
          class="ml-auto btn btn-ghost btn-sm p-2 lg:hidden"
        >
      ...
      <nav class="flex-1 py-6 px-4 space-y-2 overflow-y-auto scrollbar-thin">
        ...
        >
          <!-- Active indicator -->
          <div class="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-8 bg-gradient-to-b from-emerald-500 to-teal-600 rounded-r-full opacity-0 router-link-active:opacity-100 transition-opacity duration-300"></div>
