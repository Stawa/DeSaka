...
const sidebarWidthClass = computed(() => {
  return isCollapsed.value ? 'lg:w-16' : 'lg:w-64'
})
...
<template>
  ...
  <div class="hidden lg:block fixed left-0 top-1/2 -translate-y-1/2 z-50">
    <button
      ...
      class="flex items-center justify-center w-8 h-8 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-r-lg text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
  ...
  <!-- Sidebar -->
  <aside
    class="fixed inset-y-0 left-0 z-40 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 transition-all duration-200 lg:relative lg:translate-x-0"
  ...
  >
    <div class="h-full flex flex-col">
      ...
      <div class="flex items-center h-14 px-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <button
          @click="$emit('close')"
          class="ml-auto p-2 rounded-lg text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors lg:hidden"
        >
      ...
      <nav class="flex-1 py-4 px-3 space-y-1 overflow-y-auto">
        <RouterLink
          ...
          active-class="bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-300"
        ...
        >
          ...
          <div class="flex-shrink-0">
            <span
              class="mdi text-lg"
              :class="[`mdi-${item.icon}`, isCollapsed ? 'lg:text-xl' : '']"
            ></span>
          </div>
      ...
      <!-- Mobile theme toggle -->
      <div class="px-3 py-4 border-t border-gray-200 dark:border-gray-700 lg:hidden">
        <button
          @click="$emit('toggle-dark-mode')"
          class="w-full flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
        >
          <svg
            class="w-5 h-5"
      ...
      <!-- Footer -->
      <div
        class="px-3 py-4 border-t border-gray-200 dark:border-gray-700"
      ...
      >
        ...
        >
          ...
          <div class="flex items-center" :class="isCollapsed ? 'lg:justify-center' : ''">
            <div 
              class="w-6 h-6 rounded-lg bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center"
              :class="isCollapsed ? 'lg:w-5 lg:h-5' : ''"
            >
              <div class="w-2 h-2 bg-emerald-500 rounded-full"></div>
            </div>
          </div>
